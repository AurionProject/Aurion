...
-- -----------------------------------------------------
-- DDL for Table CONFIG_ADDRESS
-- -----------------------------------------------------

CREATE TABLE "CONFIGUSER"."CONFIG_ADDRESS" (
    "ID" NUMBER(19,0),
...
--------------------------------------------------------
  CREATE UNIQUE INDEX "CONFIGUSER"."fk_domainId" ON "CONFIGUSER"."CONFIG_ADDRESS" ("DOMAINID" ASC);
    
--------------------------------------------------------
--  Constraints for Table ADDRESS
--------------------------------------------------------
  ALTER TABLE "CONFIGUSER"."CONFIG_ADDRESS" ADD PRIMARY KEY ("ID") ENABLE;
  ALTER TABLE "CONFIGUSER"."CONFIG_ADDRESS" MODIFY ("CREATETIME" NOT NULL ENABLE);
  ALTER TABLE "CONFIGUSER"."CONFIG_ADDRESS" ADD CONSTRAINT FK_DOMAINID FOREIGN KEY (DOMAINID) REFERENCES "CONFIGUSER"."DOMAIN" (ID) ENABLE;
...
--------------------------------------------------------
--  Constraints for Table ADVANCED AUDIT
--------------------------------------------------------

  ALTER TABLE "NHINCUSER"."ADVANCED_AUDIT" ADD PRIMARY KEY ("AUDIT_ID") ENABLE;
--------------------------------------------------------
--  Constraints for Table SUBSCRIPTION
--------------------------------------------------------

  ALTER TABLE "NHINCUSER"."SUBSCRIPTION" ADD PRIMARY KEY ("ID") ENABLE;
--------------------------------------------------------
